...
public class DatabaseService {
    ...
    private final String CARD_QUERY = "CREATE TABLE cards (uuid VARCHAR ( 255 ) PRIMARY KEY, owner VARCHAR ( 255 ) NULL, packageId VARCHAR ( 255 ) NULL, cardtype VARCHAR ( 255 ) NOT NULL, elementtype VARCHAR ( 255 ) NOT NULL, storagetype VARCHAR ( 255 ) NOT NULL, damage DECIMAL(5,2) NOT NULL, locked BOOLEAN DEFAULT FALSE)";
