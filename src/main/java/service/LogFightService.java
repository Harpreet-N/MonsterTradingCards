...
public class LogFightService {
    ...
    public synchronized void printFightingResult(UserModel firstUser, UserModel secondUser, CardModel firstCard, CardModel secondCard, double firstDamage, double secondDamage, ResponseHandler responseHandler) {
